...
//   const moveUp = () => moveItem(section.subsections!, sub.id, index - 1, "subsections");
//   const moveDown = () => moveItem(section.subsections!, sub.id, index + 1, "subsections");
...
const SubsectionBlock: React.FC<Props> = ({ sub, index, section, setModal, moveItem, documents }) => {
  ...
  const moveUp = () => moveItem(section.subsections!, sub.id, "subsections", "up");
  const moveDown = () => moveItem(section.subsections!, sub.id, "subsections", "down");
